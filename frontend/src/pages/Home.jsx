    ...
    <div className="relative w-full h-screen">
      ...
      <div className='flex flex-col dark:bg-gray-950 items-center justify-center gap-20 w-full h-full lg:flex-row'>
        <div className='w-1/2 flex justify-center lg:justify-end'>
          <img src={pp} alt="logo" className="w-1/2 rounded-full" data-aos="fade-right"/>
        </div>
        <div className='w-full lg:w-1/2 text-center lg:text-left' data-aos="fade-left">
          ...
          <p className="text-2xl text-purple-1100 font-bold mb-4" data-aos="fade-up">{t('home.developer')}</p> {/* Ajout d'un espacement en bas */}
          <p className="text-lg text-slate-800 dark:text-slate-100 font-medium w-full lg:w-1/2 mb-4" data-aos="fade-up">
