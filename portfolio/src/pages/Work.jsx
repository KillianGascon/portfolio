  ...
  return (
    <div className='flex flex-col  h-screen'>
      <div>
        ...
        {/* Cartes Technos */}
        <div className="flex flex-col flex-1 w-full h-auto p-10 lg:p-28 bg-purple-100 dark:bg-gray-950 justify-center items-center gap-10 lg:gap-28">
        <h1 className="text-4xl text-purple-1100 font-bold text-center">{t('work.title_technos')}</h1>
        ...
        {/* Derniers Projets */}
        <div className="flex flex-col flex-1 w-full h-auto p-10 lg:p-28 bg-purple-100 dark:bg-gray-950 justify-center items-center gap-10 lg:gap-28">
        <h1 className="text-4xl text-purple-1100 font-bold text-center">{t('work.title_projects')}</h1>
        <div className='flex flex-col lg:flex-row justify-center items-center gap-3 lg:gap-10 w-full flex-wrap'>
        ...
        {/* Github */}
        <div className="flex flex-col lg:flex-row justify-center items-center w-full h-auto p-10 lg:p-28 bg-purple-100 dark:bg-gray-950 gap-10 lg:gap-28">
        <img src={pp_github} alt="GitHub Profile" className="w-1/4 rounded-full" />

        <div className='flex flex-col items-start gap-10 text-center lg:text-left'>
            ...
            <a href='https://github.com/KillianGascon' target="_blank" rel="noopener noreferrer" className='text-blue-600 no-underline hover:underline'>
